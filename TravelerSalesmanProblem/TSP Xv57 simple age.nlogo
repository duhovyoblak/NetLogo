...
;   set fen_value   fen_T_act *                              ( fen_T_act / fen_T_pot ) * ( 1 / fen_Q_avg )
   set fen_value   fen_T_act *                              ( fen_T_act / fen_T_pot ) * ( 1 / fen_Q_avg ) * ( fen_T_act / fen_age ) ; resete age !
...
to expanzia ;; expanduj obchodnu trasu kontext Salesman
  ...
  let source other salesmans with [ ( non_prekryv [fen_xmin] of myself [fen_xmax] of myself fen_xmin fen_xmax
                                      and prekryv [fen_ymin] of myself [fen_ymax] of myself fen_ymin fen_ymax)
                                    or
                                    ( non_prekryv [fen_ymin] of myself [fen_ymax] of myself fen_ymin fen_ymax
...
to-report non_prekryv[ amin amax bmin bmax ]
  ...
  if (amin < bmin) and (bmax > amax) [ report False ]
...
to-report prekryv[ amin amax bmin bmax ]
  ...
  if (amin < bmin) and (bmax > amax) [ report True ]

  let la amax - amin
  
  ifelse amin > bmin
  
    [ ifelse ( bmax - amin ) / la * 100 > ( 100 - max_prekryv ) [report True] [report False] ]
    [ ifelse ( amax - bmin ) / la * 100 > ( 100 - max_prekryv ) [report True] [report False] ]
